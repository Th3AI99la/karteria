...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
            ...
            ActiveProfileSecurityService activeProfileSecurityService) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // 2. REGRAS EMPREGADOR
                        .requestMatchers(
                                "/anuncios/novo", "/anuncios/salvar", "/anuncios/editar/**",
                                "/anuncios/apagar/**", "/anuncios/status/**", "/anuncios/arquivar/**",
                                "/anuncios/desarquivar/**", "/anuncios/gerenciar/**")
                        ...
                        .requestMatchers(
                                "/candidatar/**")
                        .access((authenticationSupplier, context) -> { // Usa lambda
                            Authentication authentication = authenticationSupplier.get();
                            boolean isAuthenticated = authentication != null &&
                                    authentication.isAuthenticated() &&
                                    !(authentication instanceof AnonymousAuthenticationToken);
